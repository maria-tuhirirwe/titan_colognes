...
function FragranceCard({ f, index }: { f: (typeof fragrances)[0]; index: number }) {
  ...
  const waUrl = `https://wa.me/0789230136?text=${waMsg}`
    ...
    <div className="app">
      ...
      <section id="contact" className="contact-section">
        ...
        <div className="contact-grid">
          <a
            href="https://wa.me/0789230136?text=Hi%20Titan%20Colognes!%20I%20would%20love%20to%20buy%20a%20fragrance%20%F0%9F%96%A4"
            target="_blank"
            rel="noopener noreferrer"
